...
import ink.generic.meta.definition.MetaField;
import ink.generic.meta.definition.MetaFieldArray;
import ink.generic.meta.definition.MetaRecord;
...
public class CadedDataTreeNode<T>
{
	...
	public String toCsvHeader()
	{
		...
		for (CadedDataTreeNode<T> cadedDataTreeNode : children)
		{
			if (cadedDataTreeNode.isLeaf())
				sb.append(cadedDataTreeNode.getName());
			else
				sb.append(cadedDataTreeNode.toCsvHeader());
			sb.append(",");
		}
	...
	public String toCsv()
	{
		...
		{
			if (cadedDataTreeNode.isLeaf())
				sb.append(cadedDataTreeNode.getData());
			else
				sb.append(cadedDataTreeNode.toCsv());
			sb.append(",");
		}
		sb.deleteCharAt(sb.length() - 1);
		return sb.toString();
