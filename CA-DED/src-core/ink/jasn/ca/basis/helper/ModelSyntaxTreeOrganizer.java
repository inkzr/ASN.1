...
public class ModelSyntaxTreeOrganizer
{
	 ...
	 * through few validations phases for a set of given MST-NODES. The final outcome of
	 * this tree organization is a ASN.1 master with ASN.1 type of NODE having all
